# Anteprima del sito, senza pubblicarlo

Due attrezzi per guardare il sito — o una modifica — senza metterlo online.
...
`preview-runtime.js`: rifà in JS semplice le rivelazioni allo scorrimento e
il bottom sheet. Il risultato è un unico file HTML che si apre ovunque —
anche come artifact privato — e contiene tutte e due le pagine, con una barra
in basso per passare dall'una all'altra.
...
all'ancora e aspetta che le animazioni d'ingresso finiscano.
